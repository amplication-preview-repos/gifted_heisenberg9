...
class UpdateContactInfoArgs {
  ...
  @ApiProperty({
    required: true,
    type: () => ContactInfoUpdateInput,
  })
  @ValidateNested()
  @Type(() => ContactInfoUpdateInput)
  @Field(() => ContactInfoUpdateInput, { nullable: false })
  data!: ContactInfoUpdateInput;
}

export { UpdateContactInfoArgs as UpdateContactInfoArgs };
